...
<?php echo CHtml::beginForm(Yii::app()->createUrl('admin/gallery/listorder',array('column_id'=>$column_info['id']))); ?>
<table width="100%" class="table_list">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center" width="80"><?php echo $v->num;?></td>
      ...
      <td align="center" width="120">
        <a class="cursor" onClick="openFullScreen('<?php echo Yii::app()->createUrl('admin/gallery/update',array('column_id'=>$v->column_id,'id'=>$v->id));?>')">修改</a> |
        <?php echo CHtml::link('删除',array('/admin/gallery/delete',array('column_id'=>$column_info['id'],'id'=>$v->id)),array('submit'=>array('/admin/gallery/delete','column_id'=>$v->column_id,'id'=>$v->id), 'confirm'=>'确定要删除 『 '.$v->title.' 』 吗？'))?>
      </td>                        
    </tr>
    <?php }?>
  </tbody>
...
<div class="btn">
  ...
  <p><input type="button" class="button" id="deleteAllClick" value="删除" url="<?php echo Yii::app()->createUrl('admin/gallery/deleteAll',array('column_id'=>$column_info['id']));?>" /></p>
</div>
