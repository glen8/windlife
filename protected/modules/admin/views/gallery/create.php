      ...
      <div class="left_content">
        <table width="100%" class="table_form" align="center">
          ...
          <tr>
            <th>图集</th>
            <td>
              <?php $this->widget('application.extensions.wl_fileContent.WLMultipleImageUpload',array(
              'model'=>$model,
          	  'attribute'=>'img_list',
              'attribute_alt'=>'alt_list',
              'inputCss'=>'input-text'
              ));?>
              <span style="padding-top: 12px;display:block;"><?php echo $form->error($model,'img_list'); ?></span>
            </td>
          </tr>
          <tr>
